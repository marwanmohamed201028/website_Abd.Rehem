        ...
        <div className="container mx-auto px-4 py-20 md:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-green-100 max-w-3xl mx-auto">
              ...
              you find the perfect clothing for your lifestyle.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      info@abdrehem.com<br />
                      support@abdrehem.com<br />
                      orders@abdrehem.com
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex gap-4">
                  <Link href="#" className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center hover:bg-green-600 hover:text-white transition-colors">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3">What materials are your clothes made of?</h3>
              <p className="text-gray-600">
                We use premium cotton blends, sustainable materials, and high-quality fabrics for all our products.
              </p>
            </div>
          </div>
        </div>
